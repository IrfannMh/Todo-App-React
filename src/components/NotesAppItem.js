...
function NotesAppItem({title,createdAt, body,id,onDelete, onChangeArchive}) {
 return (
  <div className='note-item'>
    ...
    <div className='note-item__action'>
      ...
      <button className='note-item__archive-button' onClick={()=> onChangeArchive(id)}>Arsipkan</button>
    </div>
  </div>
 );
}
